...
public class Buf_WR_IO_4 {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            br = new BufferedReader(new InputStreamReader(new FileInputStream("src\\lr8\\Task1\\Example9\\MyFile1.txt"), "cp1251"));
            bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("src\\lr8\\Task1\\Example9\\MyFile2.txt"), "cp1251"));
